/*
 * C implementation of OpenSimplexNoise2 by MarcoCiaramella: https://github.com/MarcoCiaramella/OpenSimplex2
 * Original OpenSimplexNoise2: https://github.com/KdotJPG/OpenSimplex2
 */
...
Grad2 *_newGrad2Arr(unsigned int size) { return (Grad2 *)malloc(sizeof(Grad2) * size); }

Grad3 *_newGrad3Arr(unsigned int size) { return (Grad3 *)malloc(sizeof(Grad3) * size); }

Grad4 *_newGrad4Arr(unsigned int size) { return (Grad4 *)malloc(sizeof(Grad4) * size); }

short *_newShortArr(unsigned int size) { return (short *)malloc(sizeof(short) * size); }
